...
import { Menu, Send, Sun, Moon, Mic, Plus, MessageSquare, Package, Paperclip, Trash2, LogOut } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen w-full bg-[var(--color-surface-chat)] text-[var(--color-text-main)] font-sans transition-colors duration-200">
      ...
      >
        ...
        <div className="p-4 border-t border-[var(--color-border-main)] flex flex-col gap-3">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 w-full py-2 rounded-lg border border-[var(--color-border-main)] text-[var(--color-text-meta)] hover:text-red-500 hover:border-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors cursor-pointer"
          >
            <LogOut size={16} />
